 ...
 * NodeRoomServer
 *
 * @class NodeRoomServer
 * @constructor
 * @param {Number} [port=3010]
 */
function NodeRoomServer(port) {
    /**
     * IO socket
     *
     * @property socket
     ...
     */
    NodeRoomServer.prototype.log = function (message, logType) {
     ...
     */
    NodeRoomServer.prototype.on = function (eventName, callback) {
     ...
     * @method start
     */
    NodeRoomServer.prototype.start = function () {
     ...
     * @param {Object} [packet]
     */
    NodeRoomServer.prototype.trigger = function (eventName, packet) {
        socket.sockets.emit(eventName, packet);
    };
}

module.exports = NodeRoomServer;
